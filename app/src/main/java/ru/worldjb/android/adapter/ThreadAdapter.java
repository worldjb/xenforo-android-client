...
/**
 * Adapter for Thread
 * Created by alex_xpert on 01.03.2015.
 */
public class ThreadAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<Thread> threads;

    public ThreadAdapter(ArrayList<Thread> _threads) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textview.setText(thread.thread_title);

        textview = (TextView) convertView.findViewById(R.id.category_description);
        textview.setText("Просмотров: " + thread.thread_view_count + ", Ответов: " + thread.thread_post_count);
